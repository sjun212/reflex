 ...
 * Generated at: 2020-01-07 02:14:51 UTC
...
public final class adminOrderList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/common/header.jsp", Long.valueOf(1578362836598L));
  ...
  static {
    ...
    _jspx_imports_classes.add("itemRentEach.model.vo.ItemRentEach");
    _jspx_imports_classes.add("order.model.vo.OrderSheet");
    _jspx_imports_classes.add("java.util.List");
    _jspx_imports_classes.add("item.model.vo.Item");
    _jspx_imports_classes.add("order.model.vo.OrderDetail2");
  }
...
if(memberLoggedIn !=null && !"admin".equals(memberLoggedIn.getMemberId())) {
	...
	int[] OSArr = (int[])request.getAttribute("OSArr");
      ...
      out.write("<<script>\r\n");
      out.write("$(()=>{\r\n");
      out.write("\tvar $search_member_id = $(\"#search_member_id\");\r\n");
      out.write("\tvar $search_rent_yn = $(\"#search_order_status\");\r\n");
      out.write("\t\r\n");
      out.write("\t$(\"#searchType\").change(function(){\r\n");
      out.write("\t\t$search_member_id.hide();\r\n");
      out.write("\t\t$search_rent_yn.hide();\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$(\"#search_\"+$(this).val()).css(\"display\", \"inline-block\");\r\n");
      out.write("\t});\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      out.write("function orderUpdate(orderNo) {\r\n");
      out.write("\tif(!confirm(\"수정하시겠습니까?\")){\r\n");
      out.write("\t\treturn false;\r\n");
      out.write("\t}\r\n");
      out.write("\tvar $orderStatus=$(\"#orderStatus-\"+orderNo).val();\r\n");
      out.write("\tlocation.href=\"");
      out.print(request.getContextPath());
      out.write("/admin/updateOrder?orderNo=\"+orderNo+\"&orderStatus=\"+$orderStatus;\r\n");
      out.write("};\r\n");
      out.write("</script>\r\n");
      out.write("<style>\r\n");
      out.write("    .height-45{\r\n");
      ...
      out.write("    }\r\n");
      out.write("    div#search_member_id {\r\n");
      out.write("\t\tdisplay:");
      out.print("member_id".equals(searchType)||searchType==null?"":"none");
      out.write(";\r\n");
      out.write("\t}\r\n");
      out.write("\tdiv#search_order_status {\r\n");
      out.write("\t\tdisplay:");
      out.print("order_status".equals(searchType)?"":"none");
      out.write(";\r\n");
      out.write("\t}\r\n");
      out.write("</style>\r\n");
      out.write("\t\t<!-- 메인 컨텐츠 -->\r\n");
      ...
      out.write("                        <tr>\r\n");
      out.write("                            <th>전체 주문 수</th>\r\n");
      out.write("                            <th>주문 완료</th>\r\n");
      out.write("                            <th>배송준비중</th>\r\n");
      out.write("                            <th>배송중</th>\r\n");
      out.write("                            <th>배송완료</th>\r\n");
      ...
      out.write("                            <option value=\"order_status\" ");
      out.print("order_status".equals(searchType)?"selected":"");
      out.write(">배송상태</option>\r\n");
      out.write("                        </select>\r\n");
      out.write("                    </div>\r\n");
      out.write("                    \r\n");
      ...
      out.print(request.getContextPath());
      out.write("/admin/orderListFinder\">\r\n");
      out.write("                        <div class=\"form-group\" id=\"search_member_id\">\r\n");
      out.write("                        \t<input type=\"hidden\" name=\"searchType\" value=\"member_id\"/>\r\n");
      out.write("                          \t<input type=\"text\" class=\"form-control\" name=\"searchKeyword\" placeholder=\"아이디를 입력하세요\" value=\"");
      ...
      out.print(request.getContextPath());
      out.write("/admin/orderListFinder\">\r\n");
      out.write("                        <div class=\"form-group\" id=\"search_order_status\">\r\n");
      out.write("                       \t \t<input type=\"hidden\" name=\"searchType\" value=\"order_status\"/>\r\n");
      out.write("                          \t<input type=\"radio\" name=\"searchKeyword\" value=\"OS01\" ");
      out.print( "OS01".equals(searchKeyword)?"checked":"" );
      out.write("/>주문완료 &nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"radio\" name=\"searchKeyword\" value=\"OS02\" ");
      out.print( "OS02".equals(searchKeyword)?"checked":"" );
      out.write("/>배송준비중 &nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"radio\" name=\"searchKeyword\" value=\"OS03\" ");
      out.print( "OS03".equals(searchKeyword)?"checked":"" );
      out.write("/>배송중 &nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"radio\" name=\"searchKeyword\" value=\"OS04\" ");
      out.print( "OS04".equals(searchKeyword)?"checked":"" );
      out.write("/>배송완료 &nbsp;&nbsp;\r\n");
      out.write("\t                        <button type=\"submit\" class=\"btn btn-default\">검색</button>\r\n");
      out.write("                        </div>\r\n");
      out.write("                        \r\n");
 ...
 if(list==null || list.isEmpty()){ 
      ...
      out.write("</td>\r\n");
      out.write("                            <td>");
      out.print(od.getOrderTotalPrice() );
      out.write("</td>\r\n");
      out.write("                            <td style=\"width: 120px;\">\r\n");
      out.write("\t                            <select class=\"form-control\" id=\"orderStatus-");
      out.print(od.getOrderNo() );
      out.write("\">\r\n");
      out.write("\t\t                            <option value=\"OS01\" ");
      out.print("주문완료".equals(orderStatus)?"selected":"");
      out.write(">주문완료</option>\r\n");
      out.write("\t\t                            <option value=\"OS02\" ");
      out.print("배송준비중".equals(orderStatus)?"selected":"");
      out.write(">배송준비중</option>\r\n");
      out.write("\t\t                            <option value=\"OS03\" ");
      out.print("배송중".equals(orderStatus)?"selected":"");
      out.write(">배송중</option>\r\n");
      out.write("\t\t                            <option value=\"OS04\" ");
      out.print("배송완료".equals(orderStatus)?"selected":"");
      out.write(">배송완료</option>\r\n");
      out.write("\t\t                        </select>\r\n");
      out.write("\t\t                    </td>\r\n");
      out.write("                            <td>\r\n");
      out.write("                            \t<button type=\"button\" id=\"updateBtn\" class=\"btn btn-xs btn-primary updateBtn\" onclick=\"orderUpdate('");
      out.print(od.getOrderNo() );
      out.write("')\" value=\"");
      out.print(od.getOrderNo() );
      out.write("\">변경</button>\r\n");
