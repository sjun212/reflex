 ...
 * Generated at: 2020-01-07 23:41:42 UTC
...
public final class mypageOneToOneForm_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(memberLoggedIn !=null && !"admin".equals(memberLoggedIn.getMemberId())) {
      ...
      out.write("\t            <form action=\"");
      out.print(request.getContextPath() );
      out.write("/mypage/mypageOneToOneFormEnd\" id=\"oneToOneFrm\" method=\"post\" enctype=\"multipart/form-data\">\n");
      out.write("\t                <div class=\"qSort-wrapper\">\n");
      out.write("\t                    <label for=\"q-sort\">문의유형</label>\n");
      out.write("\t                    <select name=\"q-sort\" id=\"q-sort\">\n");
      out.write("\t                        <option value=\"QT01\" selected>상품문의</option>\n");
      out.write("\t                        <option value=\"QT02\">배송문의</option>\n");
      out.write("\t                        <option value=\"QT03\">기타문의</option>\n");
      out.write("\t                    </select>\n");
      out.write("\t                </div>\n");
      ...
      out.write("\t                    <textarea name=\"qContent\" id=\"q-content\" cols=\"50\" rows=\"10\" required></textarea>\n");
      out.write("\t                </div>\n");
      ...
      out.write("\t                    <button type=\"submit\" class=\"btn-radius\" onclick=\"return boardValidate();\">등록</button>\n");
      out.write("\t                </div>\n");
      out.write("\t            </form>\n");
      out.write("\t        </section>\n");
      out.write("\t    </div>\n");
      ...
      out.print(request.getContextPath());
      out.write("/mypage/mypageOneToOne\";\t\n");
      out.write("\t    }\n");
      out.write("\t\tfunction boardValidate(){\n");
      out.write("\t\t\t//제목검사\n");
      out.write("\t\t\tvar $title = $(\"[name=qTitle]\");\n");
      out.write("\t\t\tif($title.val().tirm().length == 0){\n");
      out.write("\t\t\t\talert(\"제목을 입력하세요.\");\n");
      out.write("\t\t\t\treturn;\n");
      out.write("\t\t\t}\n");
      out.write("\t\t\t//내용검사\n");
      out.write("\t\t\tvar $content = $(\"[name=qContent]\");\n");
      out.write("\t\t\tif($content.val().tirm().length == 0){\n");
      out.write("\t\t\t\talert(\"내용을 입력하세요.\");\n");
      out.write("\t\t\t\treturn;\n");
      out.write("\t\t\t}\n");
      out.write("\t\t\t$(\"/mypage/mypageOneToOneFormEnd\").submit();\n");
      out.write("\t\t}\n");
      out.write("\t\t</script>\n");
      out.write("\t    <div class=\"col-md-1\"></div>\n");
      out.write("\t</div>\n");
