...
@WebServlet("/admin/itemEnrollEnd/CT04")
public class AdminItemEnrollCT04EndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public AdminItemEnrollCT04EndServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			int result=0;
			//파일 저장 경로 설정하기
			String saveImgDirectory = getServletContext().getRealPath("/images/CT04");
