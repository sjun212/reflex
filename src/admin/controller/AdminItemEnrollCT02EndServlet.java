...
@WebServlet("/admin/itemEnrollEnd/CT02")
public class AdminItemEnrollCT02EndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public AdminItemEnrollCT02EndServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			int result=0;
			//파일 저장 경로 설정하기
			String saveImgDirectory = getServletContext().getRealPath("/images/CT02");
