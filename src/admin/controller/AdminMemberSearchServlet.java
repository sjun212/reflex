...
//				System.out.printf("totalContent=%s, totalPage=%s%n", totalContent, totalPage);
				...
				//1.이전
				if(pageNo != 1) {
					pageBar += "<li><a href='"+request.getContextPath()+"/admin/member/memberSearch?cPage="+(pageNo-1)+"'><span aria-hidden='true'>&laquo;</span></a></li>\n";
				}
				...
				while(pageNo<=pageEnd && pageNo<=totalPage) {
					...
					if(cPage == pageNo) {
						...
						pageBar += "<li><a href='"+request.getContextPath()+"/admin/member/memberSearch?cPage="+pageNo+"'>"+pageNo+"</a></li>\n";				
					}
				...
				//3.다음
				if(pageNo <= totalPage) {
					pageBar += "<li><a href='"+request.getContextPath()+"/admin/member/memberSearch?cPage="+pageNo+"'><span aria-hidden='true'>&raquo;</span></a></li>\n";							
				}
