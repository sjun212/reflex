...
@WebServlet("/admin/itemEnrollEnd/CT03")
public class AdminItemEnrollCT03EndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public AdminItemEnrollCT03EndServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			int result=0;
			//파일 저장 경로 설정하기
			String saveImgDirectory = getServletContext().getRealPath("/images/CT03");
