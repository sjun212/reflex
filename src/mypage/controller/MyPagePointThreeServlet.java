...
/**
 * Servlet implementation class MyPagePointOneMonthServlet
 */
@WebServlet("/mypage/pointThree")
public class MyPagePointThreeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyPagePointThreeServlet() {
        super();
...
//				System.out.printf("totalContent=%s, totalPage=%s%n", totalContent, totalPage);
		...
		List<MyPage> list = new MyPageService().selectPointThree(memberId, cPage, numPerPage);
