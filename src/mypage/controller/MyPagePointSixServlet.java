...
/**
 * Servlet implementation class MyPagePointSixServlet
 */
@WebServlet("/mypage/pointSix")
public class MyPagePointSixServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyPagePointSixServlet() {
        super();
...
//						System.out.printf("totalContent=%s, totalPage=%s%n", totalContent, totalPage);
		...
		List<MyPage> list = new MyPageService().selectPointSix(memberId, cPage, numPerPage);
