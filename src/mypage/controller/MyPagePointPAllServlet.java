...
/**
 * Servlet implementation class MyPagePointPAllServlet
 */
@WebServlet("/mypage/pointPlusAll")
public class MyPagePointPAllServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyPagePointPAllServlet() {
        super();
...
//								System.out.printf("totalContent=%s, totalPage=%s%n", totalContent, totalPage);
				...
				List<MyPage> list = new MyPageService().selectPointPAll(memberId, cPage, numPerPage);
