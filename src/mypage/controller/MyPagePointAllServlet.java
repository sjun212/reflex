...
/**
 * Servlet implementation class MyPagePointAllServlet
 */
@WebServlet("/mypage/pointAll")
public class MyPagePointAllServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyPagePointAllServlet() {
        super();
...
//						System.out.printf("totalContent=%s, totalPage=%s%n", totalContent, totalPage);
		...
		List<MyPage> list = new MyPageService().selectPointAll(memberId, cPage, numPerPage);
