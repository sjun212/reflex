...
/**
 * Servlet implementation class MyPagePointMThreeServlet
 */
@WebServlet("/mypage/pointMThree")
public class MyPagePointMThreeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyPagePointMThreeServlet() {
        super();
...
//								System.out.printf("totalContent=%s, totalPage=%s%n", totalContent, totalPage);
				...
				List<MyPage> list = new MyPageService().selectPointMThree(memberId, cPage, numPerPage);
