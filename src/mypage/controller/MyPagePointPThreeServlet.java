...
/**
 * Servlet implementation class MyPagePointPThreeServlet
 */
@WebServlet("/mypage/pointPlusThree")
public class MyPagePointPThreeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyPagePointPThreeServlet() {
        super();
...
//								System.out.printf("totalContent=%s, totalPage=%s%n", totalContent, totalPage);
				...
				List<MyPage> list = new MyPageService().selectPointPThree(memberId, cPage, numPerPage);
