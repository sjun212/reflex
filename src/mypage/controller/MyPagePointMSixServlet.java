...
/**
 * Servlet implementation class MyPagePointMSixServlet
 */
@WebServlet("/mypage/pointMSix")
public class MyPagePointMSixServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyPagePointMSixServlet() {
        super();
...
//								System.out.printf("totalContent=%s, totalPage=%s%n", totalContent, totalPage);
				...
				List<MyPage> list = new MyPageService().selectPointMSix(memberId, cPage, numPerPage);
