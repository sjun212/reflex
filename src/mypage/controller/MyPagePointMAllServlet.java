...
/**
 * Servlet implementation class MyPagePointMAllServlet
 */
@WebServlet("/mypage/pointMAll")
public class MyPagePointMAllServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyPagePointMAllServlet() {
        super();
...
//								System.out.printf("totalContent=%s, totalPage=%s%n", totalContent, totalPage);
				...
				List<MyPage> list = new MyPageService().selectPointMAll(memberId, cPage, numPerPage);
