...
/**
 * Servlet implementation class MypageOneToOneThreeServlet
 */
@WebServlet("/mypage/mypageOneToOneThree")
public class MypageOneToOneThreeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MypageOneToOneThreeServlet() {
        super();
...
//						System.out.printf("totalContent=%s, totalPage=%s%n", totalContent, totalPage);
				...
				List<Qna> list = new qService().selectOneToOneThree(memberId, cPage, numPerPage);
