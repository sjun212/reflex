...
/**
 * Servlet implementation class MyPagePointPOneServlet
 */
@WebServlet("/mypage/pointPlusOne")
public class MyPagePointPOneServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyPagePointPOneServlet() {
        super();
...
//						System.out.printf("totalContent=%s, totalPage=%s%n", totalContent, totalPage);
		...
		List<MyPage> list = new MyPageService().selectPointPOne(memberId, cPage, numPerPage);
