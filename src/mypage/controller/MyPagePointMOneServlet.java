...
/**
 * Servlet implementation class MyPagePointMOneServlet
 */
@WebServlet("/mypage/pointMOne")
public class MyPagePointMOneServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MyPagePointMOneServlet() {
        super();
...
//								System.out.printf("totalContent=%s, totalPage=%s%n", totalContent, totalPage);
				...
				List<MyPage> list = new MyPageService().selectPointMOne(memberId, cPage, numPerPage);
