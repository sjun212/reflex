...
/**
 * Servlet implementation class MypageOneToOneAllServlet
 */
@WebServlet("/mypage/mypageOneToOneAll")
public class MypageOneToOneAllServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MypageOneToOneAllServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//							System.out.printf("totalContent=%s, totalPage=%s%n", totalContent, totalPage);
					...
					List<Qna> list = new qService().selectOneToOneAll(memberId, cPage, numPerPage);
