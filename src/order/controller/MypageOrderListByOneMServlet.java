 ...
 */
@WebServlet("/mypage/mypageOrderListByOneM")
public class MypageOrderListByOneMServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			//업무로직
			//주문번호 담은 리스트
			List<String> orderNoList = orderService.selectOrderNoByOneM(memberId);
